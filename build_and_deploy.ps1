...
if (Test-Path "C:\RaveStreamer\RaveStreamer-Windows.zip") { Remove-Item "C:\RaveStreamer\RaveStreamer-Windows.zip" -Force }
if (Test-Path "C:\RaveStreamer\RaveStreamer.apk") { Remove-Item "C:\RaveStreamer\RaveStreamer.apk" -Force }
